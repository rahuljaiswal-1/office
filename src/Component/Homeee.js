...
function Homeee() {
  return (
     ...
     <div className="container mx-auto p-8">
       <h1 className="text-4xl md:text-6xl font-semibold text-start mb-3">
         Geekyness
       </h1>
       <h1 className="text-3xl md:text-6xl  text-start mb-12">
         in Innovative Web Solutions
       </h1>

       <div className="flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-8">
         <div className="bg-gray-200 p-8 rounded-3xl w-full md:w-1/3">
           <h2 className="text-xl md:text-2xl font-bold mb-4">Innovate</h2>
           ...
           <Link to="/contact">
             <button className="text-sm border border-black rounded-full px-4 py-2 hover:bg-orange-400 mt-4">
         ...
         <div className="bg-gray-200 p-8 rounded-3xl w-full md:w-1/3">
           <h2 className="text-xl md:text-2xl font-bold mb-4">Transform</h2>
           <p className="text-gray-700">
     ...
     <section className="container mx-auto flex flex-col md:flex-row items-start space-y-4 md:space-y-0 md:space-x-4 w-full">
       ...
       <div className="w-full md:w-1/2 h-120 bg-orange-400 rounded-3xl p-4 md:p-8 text-black">
         <h2 className="text-2xl md:text-4xl font-bold mb-2">Elevate</h2>
     ...
     <section className="p-6 md:p-10 lg:p-16 flex flex-col md:flex-row mx-auto bg-white h-auto pt-12 pb-12">
       {/* First Column */}
       <div className="w-full md:w-1/2 p-6 md:p-8 lg:p-10 bg-slate-200 rounded-3xl mb-8 md:mb-0 flex flex-col items-center">
         ...
         <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-semibold text-center mb-4">
         ...
         <p className="text-sm md:text-base lg:text-lg text-center text-gray-700 leading-relaxed px-4 lg:px-8">
           ...
           processes for transformative growth.
         </p>
       </div>
       {/* Second Column */}
       <div className="w-full md:w-1/2 p-6 md:p-8 lg:p-10 bg-slate-200 rounded-3xl flex flex-col items-center">
         <svg
           className="w-12 h-12 lg:w-16 lg:h-16 text-gray-800 mb-4"
           viewBox="0 0 24 24"
           fill="none"
     ...
     <section className="hidden-animate rounded-3xl bg-gray-100 py-10 sm:py-16 px-4 sm:px-6 lg:px-8">
       <div className="max-w-7xl mx-auto text-center md:text-left">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
           ...
           <div className="bg-orange-400 p-6 rounded-3xl shadow-md h-auto w-11/12 sm:w-80 flex flex-col">
             ...
             <p className="font-semibold text-white mt-auto">Ethan Wilson, CEO</p>
